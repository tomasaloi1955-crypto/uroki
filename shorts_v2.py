...
LESSONS = {
    ...
    61: dict(hook="Слово дня: Книга", ar="كِتَاب",
             translit="Кита́б — книга",
             teach="Книга — лучший друг. Книга по-арабски — Китаб. Повтори: Китаб.",
             cta="Подпишись, учим дальше!",
             themes=["old books", "library", "arabic manuscript"]),
    62: dict(hook="Слово дня: Ручка", ar="قَلَم",
             translit="Ка́лям — ручка",
             teach="Ручка, перо по-арабски — Калям. Повтори: Калям.",
             cta="Сохрани урок!",
             themes=["fountain pen", "calligraphy pen", "writing"]),
    63: dict(hook="Слово дня: Школа", ar="مَدْرَسَة",
             translit="Ма́драса — школа",
             teach="Школа по-арабски — Мадраса. Отсюда и слово медресе. Повтори: Мадраса.",
             cta="Подпишись на канал!",
             themes=["madrasa", "school building", "samarkand registan"]),
    64: dict(hook="Слово дня: Учитель", ar="مُعَلِّم",
             translit="Муа́ллим — учитель",
             teach="Учитель по-арабски — Муаллим. Повтори: Муаллим.",
             cta="Поблагодари своего учителя — подпишись!",
             themes=["classroom", "teacher", "blackboard"]),
    65: dict(hook="Слово дня: Дверь", ar="بَاب",
             translit="Баб — дверь",
             teach="Дверь, ворота по-арабски — Баб. Повтори: Баб.",
             cta="Открой дверь в арабский — подпишись!",
             themes=["moroccan door", "arabic door", "old wooden door"]),
    66: dict(hook="Слово дня: Окно", ar="نَافِذَة",
             translit="На́физа — окно",
             teach="Окно по-арабски — Нафиза. Повтори: Нафиза.",
             cta="Сохрани, чтобы не забыть!",
             themes=["mashrabiya", "arabic window", "window"]),
    67: dict(hook="Слово дня: Ключ", ar="مِفْتَاح",
             translit="Мифта́х — ключ",
             teach="Ключ по-арабски — Мифтах. Повтори: Мифтах.",
             cta="Ключ к арабскому — подписка на канал!",
             themes=["old key", "keys", "antique key"]),
    68: dict(hook="Слово дня: Рука", ar="يَد",
             translit="Яд — рука",
             teach="Рука по-арабски — Яд. Короткое и важное слово. Повтори: Яд.",
             cta="Подпишись, чтобы не пропускать уроки!",
             themes=["hands", "henna hands", "hand"]),
    69: dict(hook="Слово дня: Глаз", ar="عَيْن",
             translit="Айн — глаз",
             teach="Глаз по-арабски — Айн. Ещё это слово значит родник. Повтори: Айн.",
             cta="Подпишись на канал!",
             themes=["eye", "oasis spring", "water spring"]),
    70: dict(hook="Слово дня: Голова", ar="رَأْس",
             translit="Раас — голова",
             teach="Голова по-арабски — Раас. Повтори: Раас.",
             cta="Сохрани урок в голове и в закладках!",
             themes=["statue head", "thinking", "portrait"]),
    71: dict(hook="Слово дня: Молоко", ar="حَلِيب",
             translit="Хали́б — молоко",
             teach="Молоко по-арабски — Халиб. Повтори: Халиб.",
             cta="Подпишись, учим дальше!",
             themes=["milk", "glass of milk", "dairy"]),
    72: dict(hook="Слово дня: Мясо", ar="لَحْم",
             translit="Ляхм — мясо",
             teach="Мясо по-арабски — Ляхм. Помнишь лахмаджун? Повтори: Ляхм.",
             cta="Сохрани, пригодится в ресторане!",
             themes=["kebab", "grilled meat", "shawarma"]),
    73: dict(hook="Слово дня: Рис", ar="أَرُزّ",
             translit="Ару́зз — рис",
             teach="Рис по-арабски — Арузз. Повтори: Арузз.",
             cta="Подпишись на канал!",
             themes=["rice", "rice field", "plov"]),
    74: dict(hook="Слово дня: Финики", ar="تَمْر",
             translit="Тамр — финики",
             teach="Финики по-арабски — Тамр. Повтори: Тамр.",
             cta="Подпишись, будет вкусно!",
             themes=["dates fruit", "date palm", "dates"]),
    75: dict(hook="Цвет дня: Чёрный", ar="أَسْوَد",
             translit="А́свад — чёрный",
             teach="Чёрный по-арабски — Асвад. Повтори: Асвад.",
             cta="Подпишись на канал!",
             themes=["black horse", "night sky", "black"]),
    76: dict(hook="Цвет дня: Синий", ar="أَزْرَق",
             translit="А́зрак — синий",
             teach="Синий, голубой по-арабски — Азрак. Повтори: Азрак.",
             cta="Сохрани урок!",
             themes=["blue mosque", "chefchaouen", "blue sea"]),
    77: dict(hook="Цвет дня: Жёлтый", ar="أَصْفَر",
             translit="А́сфар — жёлтый",
             teach="Жёлтый по-арабски — Асфар. Как пески пустыни. Повтори: Асфар.",
             cta="Подпишись, учим цвета дальше!",
             themes=["yellow flowers", "desert sand", "lemons"]),
    78: dict(hook="Считаем: Один", ar="وَاحِد",
             translit="Ва́хид — один",
             teach="Один по-арабски — Вахид. Повтори: Вахид.",
             cta="Подпишись — считаем дальше!",
             themes=["number one", "single tree desert", "one"]),
    79: dict(hook="Считаем: Два", ar="اِثْنَان",
             translit="Иснан — два",
             teach="Два по-арабски — Иснан. Повтори: Иснан.",
             cta="Подпишись — завтра три!",
             themes=["two camels", "pair", "two"]),
    80: dict(hook="Считаем: Три", ar="ثَلَاثَة",
             translit="Саля́са — три",
             teach="Три по-арабски — Саляса. Повтори: Саляса.",
             cta="Сохрани урок!",
             themes=["three pyramids", "giza pyramids", "three"]),
    81: dict(hook="Как дела?", ar="كَيْفَ الْحَال؟",
             translit="Кяйфа ль-халь — как дела?",
             teach="Спроси друга: Кяйфа ль-халь — как дела? Повтори: Кяйфа ль-халь.",
             cta="Подпишись, учим фразы!",
             themes=["friends talking", "arabic coffee", "cafe"]),
    82: dict(hook="Хорошо, слава Богу", ar="بِخَيْر",
             translit="Би-хайр — хорошо",
             teach="Ответ на как дела: Би-хайр, альхамдулиллях — хорошо, слава Богу. Повтори: Би-хайр.",
             cta="Подпишись на канал!",
             themes=["smile", "sunrise", "happy"]),
    83: dict(hook="Извини!", ar="آسِف",
             translit="А́сиф — извини",
             teach="Если ошибся, скажи: Асиф — извини. Повтори: Асиф.",
             cta="Сохрани, пригодится!",
             themes=["apology", "crowd street", "people"]),
    84: dict(hook="Пожалуйста (прошу)", ar="مِنْ فَضْلِك",
             translit="Мин фа́длик — пожалуйста",
             teach="Вежливая просьба: Мин фадлик — пожалуйста, будь добр. Повтори: Мин фадлик.",
             cta="Подпишись, будь добр!",
             themes=["arabic tea", "tea pouring", "market"]),
    85: dict(hook="Я хочу…", ar="أُرِيد",
             translit="Ури́д — я хочу",
             teach="Урид — я хочу. Урид шай — я хочу чай. Повтори: Урид.",
             cta="Хочешь больше — подпишись!",
             themes=["arabic tea", "souk", "market stall"]),
    86: dict(hook="Слово дня: Сегодня", ar="اَلْيَوْم",
             translit="Аль-яум — сегодня",
             teach="Сегодня по-арабски — Аль-яум. Повтори: Аль-яум.",
             cta="Подпишись сегодня!",
             themes=["calendar", "sunrise desert", "morning"]),
    87: dict(hook="Слово дня: Завтра", ar="غَداً",
             translit="Га́дан — завтра",
             teach="Завтра по-арабски — Гадан. До встречи завтра! Повтори: Гадан.",
             cta="Подпишись — увидимся завтра!",
             themes=["sunset", "evening sky", "desert sunset"]),
    88: dict(hook="Слово дня: Дорога", ar="طَرِيق",
             translit="Тари́к — дорога",
             teach="Дорога, путь по-арабски — Тарик. Повтори: Тарик.",
             cta="Подпишись, продолжаем путь!",
             themes=["desert road", "road", "path"]),
    89: dict(hook="Слово дня: Мир", ar="سَلَام",
             translit="Саля́м — мир",
             teach="Салям — мир и покой. Отсюда приветствие Ассаляму алейкум. Повтори: Салям.",
             cta="Салям тебе — подпишись!",
             themes=["dove", "peaceful landscape", "calm lake"]),
    90: dict(hook="Слово дня: Любовь", ar="حُبّ",
             translit="Хубб — любовь",
             teach="Любовь по-арабски — Хубб. Повтори: Хубб.",
             cta="Подпишись с любовью!",
             themes=["heart", "roses", "love"]),
}
